...
const ComingSoonPage = () => {
  const { brandStory, launchDate } = useSelector(s => s.settings);
  ...
  return (
    <div className="coming-soon-page">
      <div className="coming-soon-content">
        ...
        {brandStory && (
          <div className="coming-soon-story">
            <p>{brandStory}</p>
          </div>
        )}
      </div>
