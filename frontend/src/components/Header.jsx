...
const Header = () => {
  ...
  return (
    <>
      <header className="site-header">
        <div className="header-inner">
          ...
          <div className="header-left">
            <button className="nav-toggle" onClick={() => setDrawerOpen(true)} aria-label="Menu">
      ...
      <DrawerNav isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} user={user} onLogout={() => { dispatch(logout()); setDrawerOpen(false); }} />
    </>
  );
};
