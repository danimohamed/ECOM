    ...
    <div className="container">
      <div className="footer-grid">
        ...
        <div className="footer-col">
          ...
          <form className="footer-newsletter" onSubmit={(e) => { e.preventDefault(); alert('Thanks for subscribing!'); }}>
            <input type="email" placeholder="Rejoins la famille OPPA" required />
            <button type="submit">Subscribe</button>
          </form>
          <p style={{ marginTop: 12 }}>Be among the first to know about new drops, restocks, and events.</p>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><Link to="/flexgear">Flex Gear</Link></li>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-logo-bottom">
          <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg" style={{ height: 36 }}>
        ...
        <p className="footer-bottom-copyright">&copy; 2026, OPPA</p>
        ...
        <div className="socials">
          ...
          <a href="#" aria-label="Pinterest">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0a12 12 0 0 0-4.4 23.2c-.1-1-.2-2.4 0-3.5l1.5-6.4s-.4-.8-.4-1.9c0-1.8 1-3.2 2.4-3.2 1.1 0 1.6.8 1.6 1.8 0 1.1-.7 2.7-1 4.3-.3 1.3.6 2.3 1.9 2.3 2.3 0 4-2.4 4-5.9 0-3.1-2.2-5.2-5.4-5.2-3.7 0-5.8 2.7-5.8 5.6 0 1.1.4 2.3.9 2.9.1.1.1.2.1.3l-.4 1.4c-.1.2-.2.3-.4.2-1.5-.7-2.4-2.9-2.4-4.6 0-3.8 2.7-7.2 7.9-7.2 4.1 0 7.3 2.9 7.3 6.9 0 4.1-2.6 7.4-6.2 7.4-1.2 0-2.4-.6-2.7-1.4l-.7 2.8c-.3 1-1 2.3-1.5 3.1A12 12 0 1 0 12 0z"/></svg>
          </a>
        ...
        <div className="payments">
          <span>AMEX</span><span>APPLE PAY</span><span>MASTERCARD</span><span>VISA</span><span>GOOGLE PAY</span><span>PAYPAL</span>
        </div>
      </div>
    </div>
  </footer>
